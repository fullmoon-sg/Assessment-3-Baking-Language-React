    ...
    render() {
        ...
        return (
            <div>
                ...
                <FastRewindIcon fontSize='large' color='primary' style={styles.left_arrow} onClick={this.handle_previous} />
                <FastForwardIcon fontSize='large' color='primary' style={styles.right_arrow} onClick={this.handle_next} />
                <div>
                    <img src="https://res.cloudinary.com/fullmoon/image/upload/v1612671862/BL_logo_nuwqkf.png" alt="" height="100" width="200" style={styles.logo} />
                </div>

                <div style={styles.left_box}>
                    <Box display="flex" flexDirection="row" p={1} m={1} bgcolor="background.paper">
                        <Box p={1} bgcolor="grey.300">
                            <img src="https://res.cloudinary.com/fullmoon/image/upload/v1612666448/Image_5_y8nktp.jpg" alt="" height="275" width="275" />
                        </Box>
                          <Box p={1} bgcolor="grey.300">
                          <h4 style={{color:"white", fontWeight:"bold"}}>Receipe of the Week !!! Login to view the step-by-step instructions.</h4>
                      </Box>
                    </Box>
                ...
                <div style={styles.right_box}>
                   ...
                   <h3>Pick up or Delivery</h3> 
                      <img src="https://res.cloudinary.com/fullmoon/image/upload/v1612677549/Logo_bg_white_odzxpu.png" alt="" height="100" width="125" />
                      <h3> We share a common language</h3>
